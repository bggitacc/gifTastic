		...
		var gifTastic = {
		    ...
		    catButton: ["Gateway", "Kilobytes", "Processor", "Emoticons", "LAN", "Network", "Link", "Gify", "Logic", "Bit", "Byte", "Lossy", "Loop", "Chupacabra", "LED"],
		    ...
		    responsiveImages: function(event){
		        ...
		        $.ajax({
		            ...
		            .done(function(response) {
		                ...
		                $(".result-img").on("click", function(response) {
		                   ...
		                   gifTastic.responsiveImages(event);
